      ...
      activeJobs: g.activeJobs.map((job) =>
        job.jobId === jobId
          ? {
              ...
              repairTime: success ? Math.max(6, Math.floor(job.repairTime * 0.88)) : job.repairTime,
              rewardCoins: success ? Math.round(job.rewardCoins * 1.08) : job.rewardCoins,
              issueText: success ? "Mini-game success! Bonus applied." : "Mini-game skipped. Normal repair continues.",
            }
          : job
      ),
    }));

    setMessage(success ? "Mini-game success! Bonus applied." : "Mini-game skipped. Job continues.");
  }
